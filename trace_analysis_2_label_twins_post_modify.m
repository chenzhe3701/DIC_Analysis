...
analyze_dissimilarity_vs_schmid = 0;
if analyze_dissimilarity_vs_schmid
...
%             [m_dist, ind_t] = nanmin(pdistCS,[],2);         % [criterion-3] choose the smallest distanced twinSystem -- [minVal, ind], ind is the corresponding twin system number
    ...
    save([saveDataPath,name_result_modified],'twinMap','sfMap','disSimiMap','scoreMap','twinMap_2','shearMap','sfMap_2','costMap','clusterNumMap','stru');
