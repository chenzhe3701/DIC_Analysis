...
%
% 2019-12-08, modified from label_map_with_trace, for special use

function [sfs,angles] = script_twinVariantAnalysisProcedure_labelExample(X,Y,ID,ID_targets,ss_target,ha)
    ...
    try
        ...
        for ii = 1:length(ss_target)
            ...
            elseif is<=18
                ...
                text(x_this_nb + dx, y_this_nb + dy,['TS#',num2str(ssLabel(ii),'%2d')],'fontsize',24, 'color', 'k');
            end
