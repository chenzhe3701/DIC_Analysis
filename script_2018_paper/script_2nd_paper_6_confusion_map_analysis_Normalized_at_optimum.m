...
%% (1.2) Use [StrainScore_Normalized (c=7, H=1)], set (phi_th=0.9542)
strainScoreCF = 0.9542;    % 0.22, 0.17
shapeScoreCF = 0.2;
% previous criterion, 7Dis+(0.5-SF)< scoreCF
% i.e., new criterion, 7Dis-SF<socre-0.5
...
%% (1.3) use [eta_ShapeScore_Normalized], set (eta_th=0.5075)
...
%% (1.4) use both score [StrainScoreNormalized (c=7 H=1)] OR [ShapeScore_New], set (phi_th=0.9648)OR(eta_th=0.5075)
strainScoreCF = 0.9648;    % 0.22, 0.17
shapeScoreCF = 0.5075;
% previous criterion, 7Dis+(0.5-SF)< scoreCF
% i.e., new criterion, 7Dis-SF<socre-0.5
