...
% data files
[EBSDfileName1, EBSDfilePath1] = uigetfile('E:\PureMg_T1_EBSD\PureMg_T1_grainFile_dil_25_type_1.txt','choose the EBSD file (txt format, from type-1 grain file)');
[EBSDfileName2, EBSDfilePath2] = uigetfile('E:\PureMg_T1_EBSD\PureMg_T1_grainFile_dil_25_type_2.txt','choose the EBSD file (txt format, from type-2 grain file)');
[strainFileName, strainFilePath] = uigetfile('E:\PureMg_T1_insitu_tension\stitched_DIC\global_method_stitched_2.mat','choose one of the strain file (mat format) for aligning purpose');
...
saveDataPath = [uigetdir('E:\PureMg_T1_insitu_tension\Analysis_by_Matlab\','choose a path [to save the]/[of the saved] processed data, or WS, or etc.'),'\'];
try
